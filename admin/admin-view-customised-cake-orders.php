 ...
 <div class="btn-group">
  <?php
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="admin-view-customised-cake-orders.php?orderid=<?php echo $row['id'];?>&status=Ordered">Ordered</a></li>
						<li><a href="admin-view-customised-cake-orders.php?orderid=<?php echo $row['id'];?>&status=Pending">Pending</a></li>
                        <li><a href="admin-view-customised-cake-orders.php?orderid=<?php echo $row['id'];?>&status=Delivered">Delivered</a></li>
                        <li><a href="admin-view-customised-cake-orders.php?orderid=<?php echo $row['id'];?>&status=Cancelled">Cancelled</a></li>
                     
                      </ul>
                    </div>
</td>
<td><a href=<?php echo "admin-view-customised-cake-orders.php?deleteid=".$row['id'];?>>DELETE</a></td>
</tr>
<?php 
$cnt=$cnt+1;
}?>
