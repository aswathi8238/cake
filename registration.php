...
if(isset($_POST['user_registration']))
{
  ...
  $query=mysqli_query($con, "insert into tbl_users(name,email,password,mobile,gender,address)
            ...
            <div class="row">
                <div class="col-lg-6">
						...
						<div class="row">
							...
							<div class="col-lg-8 form-group">
								<input type="email" class="form-control" placeholder="EMAIL" name="email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
							</div>
							<div class="col-lg-4">
...
<span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password" style="font-size:24px;float: right;margin-left: -25px;margin-top: -30px;position: relative;z-index: 2;"></span>
							...
							<div class="col-lg-8 form-group">
								<input type="text" class="form-control"placeholder="MOBILE NUMBER" name="mobile" pattern="(0|91)?[6-9][0-9]{9}" required maxlength="13" minlength="10">
							</div>
							<div class="col-lg-4">
								<label>Gender</label>
							</div>
