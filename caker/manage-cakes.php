...
if(isset($_SESSION['caker_id']) && !empty($_SESSION['caker_id'])) 
{
   ...
   if(isset($_POST['save_cake']))
   {
     ...
     $query=mysqli_query($con, "insert into tbl_cake(cake_name,category_name,cake_price,photo,caker_id,discount) values('$cake_name','$category_name',$price,'$target_file',$caker_id,$discount)");
     if ($query) {
...
if (isset($_GET['editid'])) 
{
    ...
    while ($row=mysqli_fetch_array($ret)) 
    {
		...
		$edit_discount_value  = $row['discount'];
...
if(isset($_POST['update_cake']))
  {
    ...
    $query=mysqli_query($con, "update tbl_cake set cake_name = '$cake_name' , category_name = '$category_name' , cake_price = $price ,photo = '$target_file',discount = $discount where id =".$editid);
    if ($query) {
        ...
        <section class="content">
              ...
              <div class="row">
				...
				<div class="col-md-3">
                  <div class="form-group">
					  ...
					  <input type="text" class="form-control" name="discount" placeholder="Discount" required value="<?php echo $edit_discount_value;?>">
                    </div>
         ...
         <input type="file" name="fileToUpload" class="form-control" required> 
              ...
              <div class="col-md-2"><br>
				<div class="form-group">
				 <input type="hidden" name="hfid" value="<?php  echo $hfid;?>"> 
				 <input type="hidden" name="hfcakerid" value="<?php  echo $caker_id;?>"> 
...
<?php
$query = "select * from tbl_cake where caker_id = $caker_id";
...
<td><a href=<?php echo "manage-cakes.php?editid=".$row['id'];?>>EDIT</a></td>
<td><a href=<?php echo "manage-cakes.php?deleteid=".$row['id'];?>>DELETE</a></td>
</tr>
<?php 
$cnt=$cnt+1;
}?>
